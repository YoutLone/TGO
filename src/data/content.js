export const content = {
  my: {
    ...
    gallery: [
      { label: "သန့်ရှင်းအေးချမ်းတဲ့ ဆိုင်ပတ်ဝန်းကျင်နဲ့ စားပွဲများ", image: "/gallery/memory-2.jpeg" },
      { label: "သန့်ရှင်းအေးချမ်းတဲ့ ဆိုင်ပတ်ဝန်းကျင်နဲ့ စားပွဲများ", image: "/gallery/memory-3.jpeg" },
      { label: "သန့်ရှင်းအေးချမ်းတဲ့ ဆိုင်ပတ်ဝန်းကျင်နဲ့ စားပွဲများ", image: "/gallery/memory-4.jpeg" }
    ],
    ...
    galleryItems: [
      {
        title: "မီးဖိုချောင်ဧရိယာ",
        caption: "ဟင်းရည်ပြင်ဆင်ခြင်းနှင့် Reservation Counter။",
